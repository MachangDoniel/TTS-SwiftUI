...
struct AudioDownloadManagerView: View {
        ...
        NavigationView {
            VStack {
                if downloader.isDownloading {
                    AudioDownloadProgressSection(downloader: downloader)
                }
                
                AudioDownloadedFilesSection(downloader: downloader)
...
struct AudioDownloadProgressSection: View {
...
struct AudioDownloadedFilesSection: View {
    @ObservedObject var downloader: UniversalAudioDownloader
    
    var body: some View {
        List {
            ForEach(downloader.downloadedFiles) { file in
                AudioDownloadedFileRow(file: file, downloader: downloader)
            }
...
struct AudioDownloadedFileRow: View {
    let file: AudioFile
    @ObservedObject var downloader: UniversalAudioDownloader
